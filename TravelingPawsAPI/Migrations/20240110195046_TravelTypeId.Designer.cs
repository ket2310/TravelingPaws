...
namespace TravelingPawsAPI.Migrations
{
    ...
    [Migration("20240110195046_TravelTypeId")]
    partial class TravelTypeId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelingPawsAPI.Models.Trip", b =>
                {
                    b.Property<int>("TripId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelingPawsAPI.Models.PetOwner", b =>
                {
                    b.HasOne("TravelingPawsAPI.Models.Cat", "cat")
                        .WithMany()
                        .HasForeignKey("catId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelingPawsAPI.Models.Dog", "dog")
                        .WithMany()
                        .HasForeignKey("dogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TravelingPawsAPI.Models.Quote", b =>
                {
                    ...
                    b.HasOne("TravelingPawsAPI.Models.Trip", "trip")
                        .WithMany()
